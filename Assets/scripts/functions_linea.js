...
function Select() {
    ...
    fetch(ajaxUrl, {
        ...
        .then(resp => {
            if (resp == '') {
                $('#idcategoria').html('').trigger("change");
                $('#idcategoria').append('<option>No Existen Registros</option>');
            } else {
                $('#idcategoria').html('').trigger("change");
                $('#idcategoria').html(resp).trigger("change");
            }
        });
...
function InsertarEditar() {
    document.addEventListener('submit', function(e) {
        ...
        let strCampo = document.querySelectorAll("#cod_linea,#desc_linea");
...
function mostrar(idlinea) {
    ...
    dataset.append('idlinea', idlinea);

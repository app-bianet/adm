...
function Operacion(operacion) {
    switch (operacion) {
        ...
        case "nuevo":
            ...
            $("input[type=checkbox]").attr("disabled", true).val(0);
            EventoCheckBox();
            MostrarForm(true);
            break;
        ...
        case "mostrar":
            ...
            $("#btnGuardar,input[type=checkbox]").attr("disabled", true);
            EventoCheckBox();
            MostrarForm(true);
            break;
...
function mostrar(idmoneda) {
    ...
    dataset.append('idmoneda', idmoneda);
    ...
    fetch(urlAjax, {
        ...
        .then(response => {
            $.each(response, function(label, valor) {
                ...
                // $("#factor").val(addCommas(response.factor));
            console.log();
            Editar();
            Cancelar();
            proceso = "mostrar";

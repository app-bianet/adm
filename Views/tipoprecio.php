        ...
        <form id="dataForm" name="dataForm">
          <div class="form-row">
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <label for="cod_tipoprecio">Código</label>
              <input type="textc" id="cod_tipoprecio" name="cod_tipoprecio" 
              class="form-control form-control-border form-control-sm" placeholder="Código">
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
            </div>
            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
              <label for="desc_tipoprecio">Descripción</label>
              <input type="text" id="desc_tipoprecio" name="desc_tipoprecio" 
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-top">
              <input type="text" id="idtipoprecio" name="idtipoprecio" class="hidden">

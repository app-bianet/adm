      ...
      <form name="tableForm" id="tableForm">
        <table id="tbdetalle" class="table table-bordered table-hover compact table-sm table-striped" style="width:100% !important;">
          <thead class="bg-blue">
            ...
            <th class="text-center nd" style="width:85px">M.Base</th>
            <th class="text-center nd" style="width:55px">Simbolo</th>
            <th class="text-center nd" style="width:90px">Factor</th>
        ...
        <form id="dataForm" name="dataForm">
          <div class="form-row">
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <label for="cod_moneda">Código</label>
              <input type="textc" id="cod_moneda" name="cod_moneda" 
            ...
            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
              ...
              <input type="text" id="desc_moneda" name="desc_moneda" 
            ...
            <div class="form-group col-lg-3 col-md-3 col-sm-12 col-xs-12">
              ...
              <input type="checkbox" id="base" name="base" class="checkbox-inline chk"> Es Moneda Base </label>   
            </div>
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
            ...
            <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-6">
              <div class="input-group input-group-sm">
                <div class="input-group-prepend"><span class="input-group-text small"> Factor de Cambio:</span>
                </div>          
                <input type="text" class="form-control nformat" name="factor" id="factor">
              </div>
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-top">
              <input type="text" id="idmoneda" name="idmoneda" class="hidden">

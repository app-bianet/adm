          ...
          <div class="form-row">
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <div class="input-group">  
                ...
                <input type="textc" id="cod_cliente" name="cod_cliente" 
            ...
            <div class="form-group col-lg-10 col-md-10 col-sm-12 col-xs-12">
              <input type="text" id="desc_cliente" name="desc_cliente" 
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <div class="input-group">  
                ...
                <select name="idtipocliente" id="idtipocliente" class="form-control"></select>
              </div>
            </div>
            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <div class="input-group">  
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <div class="input-group">  
                <div class="input-group-prepend">
                  <span class="input-group-text small">Vendedor: </span>
                </div>  
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-top">
              <input type="text" id="idcliente" name="idcliente" class="hidden">

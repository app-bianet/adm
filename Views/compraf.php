          ...
          <div class="form-row">
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-12 col-xs-12">
              <div class="input-group">
                ...
                <input type="textx" id="origend" name="origend" class="form-control" placeholder="Doc. Origen" readonly value="Factura">
                <div class="input-group-prepend">
            ...
            <div class="form-group col-lg-8 col-md-8 col-sm-12 col-xs-12">
              ...
              <input type="text" class="form-control" name="desc_proveedor" id="desc_proveedor" 
                maxlength="250" placeholder="Proveedor">
            ...
            <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">
              ...
              placeholder="N° de Factura" required="required">
            </div>
            <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">

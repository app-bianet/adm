        ...
        <form id="dataForm" name="dataForm">
          <div class="form-row">
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              ...
              <input type="textc" id="cod_linea" name="cod_linea" 
              class="form-control form-control-border form-control-sm" placeholder="Código">
            </div>
            <div class="form-group col-lg-6 col-md-6 col-sm-12 col-xs-12">
              <label for="idcategoria"> Categoría:</label>
              <select class="form-control dt" name="idcategoria" id="idcategoria">
              </select>
            </div>
            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
              <label for="desc_linea">Descripción</label>
              <input type="text" id="desc_linea" name="desc_linea" 
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-top">
              <input type="text" id="idlinea" name="idlinea" class="hidden">

        ...
        <form id="dataForm" name="dataForm">
          <div class="form-row">
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <label for="cod_tipoproveedor"> Código</label>
              <input type="textc" id="cod_tipoproveedor" name="cod_tipoproveedor" 
            ...
            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
              ...
              <input type="text" id="desc_tipoproveedor" name="desc_tipoproveedor" 
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-top">
              <input type="text" id="idtipoproveedor" name="idtipoproveedor" class="hidden">

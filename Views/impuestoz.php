          ...
          <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6" style="padding-left:15px; padding-right:0px">
            <div class="input-group">
              <div class="input-group-prepend">
                ...
                <input type="textz" id="cod_impuestoz" name="cod_impuestoz" 
                class="form-control" placeholder="Código" readonly>    
            </div>
          </div>
          <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-6 no-padding">
            <select name="idimpuestozh" id="idimpuestozh" class="form-control"></select>
          </div>

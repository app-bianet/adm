        ...
        <form id="dataForm" name="dataForm">
          <div class="form-row">
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <div class="input-group">
                <div class="input-group-prepend">
                  <span for="cod_ajuste" class="input-group-text">Código</span>
                </div>
                <input type="textc" id="cod_ajuste" name="cod_ajuste" class="form-control" placeholder="Código">
              </div>
            </div>
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <div class="input-group">
            ...
            <div class="form-group col-lg-4 col-md-4 col-sm-6 col-xs-6">
              <div class="input-group">
                <div class="input-group-prepend">
                <span for="deposito" class="input-group-text">Deposito: </span>
                </div>
            ...
            <div class="form-group col-lg-10 col-md-10 col-sm-12 col-xs-12">
              ...
              <input type="text" id="desc_ajuste" name="desc_ajuste" class="form-control" placeholder="Descripción">
              </div>
            </div>
            <div class="form-group col-lg-2 col-md-2 col-sm-8 col-xs-8">          
              <button id="btnAgregarArt" type="button" class="btn btn-primary btn-sm" disabled> 
            ...
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-top">
              <input type="text" id="idajuste" name="idajuste" class="hidden">

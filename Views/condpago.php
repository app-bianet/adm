        ...
        <form id="dataForm" name="dataForm">
          <div class="form-row">
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <label for="cod_condpago">Código</label>
              <input type="textc" id="cod_condpago" name="cod_condpago" 
            ...
            <div class="form-group col-lg-8 col-md-8 col-sm-8 col-xs-8">
              ...
              <input type="text" id="desc_condpago" name="desc_condpago" 
            ...
            <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-6">
              <div class="input-group input-group-sm">
                <div class="input-group-prepend"><span class="input-group-text small"> Días:</span>
                </div>          
                <input type="textn" class="form-control text-right" name="dias" id="dias">
              </div>
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
            </div>
            <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12 padd-top">
              <input type="text" id="idcondpago" name="idcondpago" class="hidden">

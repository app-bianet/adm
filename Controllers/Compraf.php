<?php
class Compraf extends Controllers{

  public function __construct(){   
    parent::__construct();
  }

  public function compraf(){
    ob_start();
    session_start();
    if (!isset($_SESSION["sidusuario"])){
      ...
      if ($_SESSION['compraf']==1){     
        $data['page_tag']="Factura de Compra";
        $data['page_title']=".:: Factura de Compra ::.";
        $data['page_name']="compraf";
        $data['func']="functions_compra.js";
        $this->views->getView($this,"compraf",$data);
      } else {
  ...
  public function Listar(){
    if (isset($_POST["security"])) {
      $arrData=$this->model->SelectDt('Factura');
      $al='style="text-align:';
      $w='; width:';
